...
void plotClusterPions(const std::string& fileName="ml_pions.hist.root",const std::string& fdir="plots",double minEntries=50.) {
  ...
  static const std::vector<Types::Hist::Identifier> knownHists = { 
   ...
   /* 16 */ Types::Hist::identify("EMR_rho__incl","TH2D","RES",Types::Axis::description(std::pow(10.,-8.5),std::pow(10.,-3.5),true,"#rho_{clus} [GeV/mm^{3}]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),  
   /* 17 */ Types::Hist::identify("LCR_rho__incl","TH2D","RES",Types::Axis::description(std::pow(10.,-8.5),std::pow(10.,-3.5),true,"#rho_{clus} [GeV/mm^{3}]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),  
   /* 18 */ Types::Hist::identify("MLR_rho__incl","TH2D","RES",Types::Axis::description(std::pow(10.,-8.5),std::pow(10.,-3.5),true,"#rho_{clus} [GeV/mm^{3}]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  )),  
   /* 19 */ Types::Hist::identify("EMR_rho__e300","TH2D","RES",Types::Axis::description(std::pow(10.,-8.5),std::pow(10.,-3.5),true,"#rho_{clus} [GeV/mm^{3}]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),  
   /* 20 */ Types::Hist::identify("LCR_rho__e300","TH2D","RES",Types::Axis::description(std::pow(10.,-8.5),std::pow(10.,-3.5),true,"#rho_{clus} [GeV/mm^{3}]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),  
   /* 21 */ Types::Hist::identify("MLR_rho__e300","TH2D","RES",Types::Axis::description(std::pow(10.,-8.5),std::pow(10.,-3.5),true,"#rho_{clus} [GeV/mm^{3}]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  )),  
   /* 22 */ Types::Hist::identify("EMR_lamb_incl","TH2D","RES",Types::Axis::description(10.,5000.,true,"#lambda_{clus} [mm]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),  
   /* 23 */ Types::Hist::identify("LCR_lamb_incl","TH2D","RES",Types::Axis::description(10.,5000.,true,"#lambda_{clus} [mm]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),  
   /* 24 */ Types::Hist::identify("MLR_lamb_incl","TH2D","RES",Types::Axis::description(10.,5000.,true,"#lambda_{clus} [mm]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  )),  
   /* 25 */ Types::Hist::identify("EMR_lamb_e300","TH2D","RES",Types::Axis::description(10.,5000.,true,"#lambda_{clus} [mm]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),  
   /* 26 */ Types::Hist::identify("LCR_lamb_e300","TH2D","RES",Types::Axis::description(10.,5000.,true,"#lambda_{clus} [mm]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),  
   /* 27 */ Types::Hist::identify("MLR_lamb_e300","TH2D","RES",Types::Axis::description(10.,5000.,true,"#lambda_{clus} [mm]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  )),  
   /* 28 */ Types::Hist::identify("EMR_long_incl","TH2D","RES",Types::Axis::description(0.,1.,false,"#LTm^{2}_{long}#GT"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),
   /* 29 */ Types::Hist::identify("LCR_long_incl","TH2D","RES",Types::Axis::description(0.,1.,false,"#LTm^{2}_{long}#GT"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),
   /* 30 */ Types::Hist::identify("MLR_long_incl","TH2D","RES",Types::Axis::description(0.,1.,false,"#LTm^{2}_{long}#GT"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  )),
   /* 31 */ Types::Hist::identify("EMR_long_e300","TH2D","RES",Types::Axis::description(0.,1.,false,"#LTm^{2}_{long}#GT"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),  
   /* 32 */ Types::Hist::identify("LCR_long_e300","TH2D","RES",Types::Axis::description(0.,1.,false,"#LTm^{2}_{long}#GT"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),  
   /* 33 */ Types::Hist::identify("MLR_long_e300","TH2D","RES",Types::Axis::description(0.,1.,false,"#LTm^{2}_{long}#GT"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  )),  
   /* 34 */ Types::Hist::identify("EMR_lat__incl","TH2D","RES",Types::Axis::description(0.,1.,false,"#LTm^{2}_{lat}#GT"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),  
   /* 35 */ Types::Hist::identify("LCR_lat__incl","TH2D","RES",Types::Axis::description(0.,1.,false,"#LTm^{2}_{lat}#GT"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),  
   /* 36 */ Types::Hist::identify("MLR_lat__incl","TH2D","RES",Types::Axis::description(0.,1.,false,"#LTm^{2}_{lat}#GT"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  )),  
   /* 37 */ Types::Hist::identify("EMR_lat__e300","TH2D","RES",Types::Axis::description(0.,1.,false,"#LTm^{2}_{lat}#GT"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),  
   /* 38 */ Types::Hist::identify("LCR_lat__e300","TH2D","RES",Types::Axis::description(0.,1.,false,"#LTm^{2}_{lat}#GT"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),  
   /* 39 */ Types::Hist::identify("MLR_lat__e300","TH2D","RES",Types::Axis::description(0.,1.,false,"#LTm^{2}_{lat}#GT"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  )),  
   /* 40 */ Types::Hist::identify("EMR_sign_incl","TH2D","RES",Types::Axis::description(1.,2500.,true,"#zeta_{clus}^{em}"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),
   /* 41 */ Types::Hist::identify("LCR_sign_incl","TH2D","RES",Types::Axis::description(1.,2500.,true,"#zeta_{clus}^{em}"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),
   /* 42 */ Types::Hist::identify("MLR_sign_incl","TH2D","RES",Types::Axis::description(1.,2500.,true,"#zeta_{clus}^{em}"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  )),
   /* 43 */ Types::Hist::identify("EMR_sign_e300","TH2D","RES",Types::Axis::description(1.,2500.,true,"#zeta_{clus}^{em}"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),
   /* 44 */ Types::Hist::identify("LCR_sign_e300","TH2D","RES",Types::Axis::description(1.,2500.,true,"#zeta_{clus}^{em}"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),
   /* 45 */ Types::Hist::identify("MLR_sign_e300","TH2D","RES",Types::Axis::description(1.,2500.,true,"#zeta_{clus}^{em}"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  )),
   /* 46 */ Types::Hist::identify("EMR_ptd__incl","TH2D","RES",Types::Axis::description(0.,1.,false,"p_{t}D"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),
   /* 47 */ Types::Hist::identify("LCR_ptd__incl","TH2D","RES",Types::Axis::description(0.,1.,false,"p_{t}D"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),
   /* 48 */ Types::Hist::identify("MLR_ptd__incl","TH2D","RES",Types::Axis::description(0.,1.,false,"p_{t}D"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  )),
   /* 49 */ Types::Hist::identify("EMR_ptd__e300","TH2D","RES",Types::Axis::description(0.,1.,false,"p_{t}D"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),
   /* 50 */ Types::Hist::identify("LCR_ptd__e300","TH2D","RES",Types::Axis::description(0.,1.,false,"p_{t}D"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),  
   /* 51 */ Types::Hist::identify("MLR_ptd__e300","TH2D","RES",Types::Axis::description(0.,1.,false,"p_{t}D"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  )),  
   /* 52 */ Types::Hist::identify("EMR_time_incl","TH2D","RES",Types::Axis::description(0.,2.,false,"#sigma_{t} [ns]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),  
   /* 53 */ Types::Hist::identify("LCR_time_incl","TH2D","RES",Types::Axis::description(0.,2.,false,"#sigma_{t} [ns]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),  
   /* 54 */ Types::Hist::identify("MLR_time_incl","TH2D","RES",Types::Axis::description(0.,2.,false,"#sigma_{t} [ns]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  )),  
   /* 55 */ Types::Hist::identify("EMR_time_e300","TH2D","RES",Types::Axis::description(0.,2.,false,"#sigma_{t} [ns]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),  
   /* 56 */ Types::Hist::identify("LCR_time_e300","TH2D","RES",Types::Axis::description(0.,2.,false,"#sigma_{t} [ns]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),  
   /* 57 */ Types::Hist::identify("MLR_time_e300","TH2D","RES",Types::Axis::description(0.,2.,false,"#sigma_{t} [ns]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  ))  
  };   
  ...
  std::map<std::string,Types::Canvas::Identifier>  knownCanvas = {
   ...
   { Types::Hist::name(knownHists.at(34)), { "ClusterResponseEMvsLatIncl", "cluster_em_response_lat_incl"   } },  
   { Types::Hist::name(knownHists.at(35)), { "ClusterResponseLCvsLatIncl", "cluster_lc_response_lat_incl"   } },  
   { Types::Hist::name(knownHists.at(36)), { "ClusterResponseMLvsLatIncl", "cluster_ml_response_lat_incl"   } },  
   { Types::Hist::name(knownHists.at(37)), { "ClusterResponseEMvsLatHigh", "cluster_em_response_lat_e300"   } },  
   { Types::Hist::name(knownHists.at(38)), { "ClusterResponseLCvsLatHigh", "cluster_lc_response_lat_e300"   } },  
   { Types::Hist::name(knownHists.at(39)), { "ClusterResponseMLvsLatHigh", "cluster_ml_response_lat_e300"   } },  
