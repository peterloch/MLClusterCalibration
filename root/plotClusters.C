...
void plotClusters(const std::string& fileName="ml_pions.hist.root",const std::string& fdir="plots",double minEntries=50.) {
  ...
  static const std::vector<Types::Hist::Identifier> knownHists = { 
   ...
   /* 52 */ Types::Hist::identify("EMR_time_incl","TH2D","RES",Types::Axis::description(0.,5.,false,"#sigma_{t} [ns]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),  
   /* 53 */ Types::Hist::identify("LCR_time_incl","TH2D","RES",Types::Axis::description(0.,5.,false,"#sigma_{t} [ns]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),  
   /* 54 */ Types::Hist::identify("MLR_time_incl","TH2D","RES",Types::Axis::description(0.,5.,false,"#sigma_{t} [ns]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  )),  
   /* 55 */ Types::Hist::identify("EMR_time_e300","TH2D","RES",Types::Axis::description(0.,5.,false,"#sigma_{t} [ns]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{em}/E_{clus}^{dep}"  )),  
   /* 56 */ Types::Hist::identify("LCR_time_e300","TH2D","RES",Types::Axis::description(0.,5.,false,"#sigma_{t} [ns]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{had}/E_{clus}^{dep}" )),  
   /* 57 */ Types::Hist::identify("MLR_time_e300","TH2D","RES",Types::Axis::description(0.,5.,false,"#sigma_{t} [ns]"),Types::Axis::description(1.,-1.,false,"E_{clus}^{ml}/E_{clus}^{dep}"  ))  
  };   
